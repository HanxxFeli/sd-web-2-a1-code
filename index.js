...
let printErrorHandledCharNames = (array) => { 
  array.forEach(character => { 
    if (character.name === "") { 
      errorMessages.innerHTML += `<p>Character with age ${character.age} does not have a name</p>`
      console.error("Character does not have a name"); // log console error if char name doesnt exist
    } else 
 ...
 printErrorHandledCharNames(users2); // call the function for error handling function
...
let brokenArrayCharList = (array) => { 
  array.forEach(character => { 
    if (character.name === "") { 
      brokenArrayErrors.innerHTML += `<p>Character with age ${character.age} does not have a name</p>`
      console.error("Character does not have a name"); // log console error if char name doesnt exist
    } else 
      brokenArrayList.innerHTML += `<li>${character.name}</li>`
      console.log(character.name);
  })
};
